            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: const Color.fromARGB(255, 144, 32, 133),
                  // boxShadow: [
                  //   BoxShadow(
                  //     color: Colors.purple.withOpacity(0.3),
                  //     blurRadius: 10,
              ...
              const Text(
                ...
                style: TextStyle(
                  color: Color.fromARGB(255, 144, 32, 133),
                  fontSize: 14,
                ...
                children: [
                  ...
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color.fromARGB(255, 144, 32, 133),
                    ...
                    onPressed: () {
                      ...
                      if (_phoneController.text.isNotEmpty) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content:
                                Text('Calling you at ${_phoneController.text}'),
                            backgroundColor:
                                const Color.fromARGB(255, 144, 32, 133),
                          ),
                        );
                      }
          ...
          child: Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  const Color.fromARGB(255, 144, 32, 133).withOpacity(0.3),
